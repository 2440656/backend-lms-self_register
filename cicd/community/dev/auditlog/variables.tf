...
variable "user-audit-log-lambda-role-name" {
  type        = string
  description = "IAM Role name for User Audit Log Lambda"
}

variable "user-audit-log-lambda-policy-name" {
  type        = string
  description = "IAM Policy name for User Audit Log Lambda"
}
