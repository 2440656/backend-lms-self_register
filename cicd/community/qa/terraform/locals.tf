locals {
  ...
  lambda_authorizer_functionname = "qa-lms-lambda-authorizer"
  ...
  acm_certificate_arn  = "arn:aws:acm:us-east-1:050752635551:certificate/54153dc3-71d5-4fa7-864a-2d3b92ca04d6"
  acm_certificate_failover_arn  = "arn:aws:acm:us-west-2:050752635551:certificate/5e9b5497-c456-468f-b480-149acda80ec1"
  create_domain_entry  = true
  create_route53_entry = true

  hosted_zone_name   = "qa.lms.cognizant.com"
