...
resource "aws_dynamodb_table_item" "user_service_table_item2" {
  ...
  item = <<ITEM
  {
        "pk": {"S": "e92e1095-d380-4cf1-8210-96f7db9853e0"},
        "sk": {"S": "acad4b4b-1db7-4a9d-87f9-39912f96a17e"},
        "tenantCode": {"S": "cognizant"},
        "createdOn": {"S": "9/22/2025  3:55:32 AM"},
        "gsiSortFNLN": {"S": "Syam#Sankar"},
        "status": {"S": "Active"},
        "userType": {"S": "Internal"},
        "loginOption": {"S": "CognizantSSO"},
        "institutionName": {"S": "Cognizant"},
        ...
        "lastName": {"S": "Sankar"},
        "role": {"S": "system-admin,content-author,learner,super-admin"},
        "emailId": {"S": "syam.sankar2@cognizant.com"},
        "name": {"S": "syamsankar"},
        "userAccountExpiryDate": {"S": "12/21/2035"},
        "lastLoginTimestamp": {"S": "2025-09-22T09:56:23.900567732Z"},
        "modifiedBy": {"S": "system"},
