...
| Users             | pk           | sk          |
| Roles             | pk           | sk          |
| OperationsHistory | pk           | sk          |
| SkillLookups      | pk           | sk          |

#### Required GSIs for Users Table
...
#### Required GSIs for SkillLookup Table

| globalIndexName     | partitionKey | sortKey               |
|:--------------------|:-------------|:----------------------|
| gsi-Type            | type         | name                  |

#### Required Fields and Data for Roles Table 

| pk       | sk             | type     | name           | description               | active    |
|:---------|:---------------|:---------|:---------------|:--------------------------|:----------|
| Role     | super-admin    | role     | Super Admin    | Application Administrator | true      |
| Role     | system-admin   | role     | System Admin   | Tenant Administrator      | true      |
| Role     | content-author | role     | Content Author | Content Author            | true      |
| Role     | catalog-admin  | role     | Catalog Admin  | Catalog Admin             | true      |
| Role     | learner        | role     | Learner        | Learner                   | true      |
| Role     | mentor         | role     | Mentor         | Mentor                    | true      |

#### Required GSIs for OperationsHistory Table
...
AWS_DYNAMODB_SKILL_LOOKUPS_TABLE_NAME=skill;
REGION_NAME=us-east-1;
AWS_S3_BUCKET_NAME=<s3-bucket>;
LOCAL_STORAGE_PATH=<your-local-path>;
DEFAULT_ROWS_PER_PAGE=10;
AWS_DYNAMODB_LOGFILE_TABLE_NAME=OperationsHistory;
AWS_DYNAMODB_LOGFILE_TABLE_PARTITION_KEY_NAME=tenantCode;
...
LMS_ADMIN_EMAIL=lmsAdmin@cognizant.com;
LMS_FROM_EMAIL_ADDRESS=no-reply@cognizantproducts.com;
LMS_URL=https://dev.lms.cognizantproducts.com/;
```
